  ...
  return (
    <div className="calculator-container">
      ...
      <div className="privacy-button-container">
        <Link
          href="/heavy-duty-calculator/privacypolicy"
        ...
        >
          <div className="modal-content">
            ...
            <p>
              ...
              <strong>Google Play Console</strong> and complies with all
              relevant <strong>U.S. laws</strong> and{" "}
              <strong>AdMob policies</strong>.
            </p>
            <p>
              Please review the{" "}
              <Link href="/heavy-duty-calculator/privacy-policy">
                Privacy Policy
              </Link>{" "}
              before downloading.
            </p>
